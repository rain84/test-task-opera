...
export const IconBellOff = Icon(BellOffSvg)
export const IconBulb = Icon(BulbSvg)
export const IconCog = Icon(CogSvg)
export const IconDrop = Icon(DropSvg)
export const IconLeaf = Icon(LeafSvg)
export const IconPodium = Icon(PodiumSvg)
export const IconPot = Icon(PotSvg)
export const IconSnowflake = Icon(SnowflakeSvg)
